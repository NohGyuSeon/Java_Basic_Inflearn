...
public class StringFactoryProcess {
	...
	public static Queue<String> rawMaterialPlasticList = new LinkedList<String>();
	public static Queue<Map<String, Integer>> productStringList = new LinkedList<Map<String, Integer>>();
	public static Queue<Map<Integer, Map<String, Integer>>> inputList = new LinkedList<Map<Integer, Map<String, Integer>>>();
